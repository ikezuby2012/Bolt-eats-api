...
namespace Infrastructure.Database.Migrations
{
    ...
    [Migration("20260323201202_createdRefreshTokenTable")]
            ...
            modelBuilder.Entity("Domain.Auth.RefreshToken", b =>
                {
                    ...
                    b.HasIndex("IsRevoked", "IsUsed", "ExpiresAt")
                        .HasDatabaseName("ix_tbl_refresh_token_active")
                        .HasFilter("is_soft_deleted = false AND is_revoked = false AND is_used = false AND expires_at > NOW()");
