...
internal sealed class PaymentConfirmedEventHandler(
    ...
    IApplicationDbContext context) : IDomainEventHandler<PaymentConfirmedEvent>
{
    public async Task Handle(PaymentConfirmedEvent domainEvent, CancellationToken cancellationToken)
    {
